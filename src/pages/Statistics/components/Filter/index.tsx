      ...
      <div className="filter-group">
        ...
        <div className="filter-item">
          ...
          <Select
            allowClear
            placeholder="Тип"
            value={query?.payment_type ?? null}
            onChange={(v) =>
              stringifyPush({ ...query, payment_type: v || undefined, page: 1 })
            }
            style={{ minWidth: 180 }}
          >
            <Option value="cash">Наличные</Option>
            <Option value="rfid_top_up">RFID Карта</Option>
